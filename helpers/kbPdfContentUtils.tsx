...
export const MODULES_DATA = [
  ...
  { title: "Payment History Manipulation", desc: "Identifies impossible or legally prohibited payment pattern updates.", sev: "ERROR" },
  ...
  { title: "Procedural Timing Violations", desc: "Flags violations of statutory investigation response timeframes.", sev: "ERROR" },
  { title: "Multiple Collector Violations", desc: "Detects multiple agencies reporting or collecting on the same debt simultaneously.", sev: "WARNING" },
  ...
  { title: "Bankruptcy Discharge Violations", desc: "Flags attempts to collect or report balances on debts discharged in bankruptcy.", sev: "ERROR" },
  ...
  { title: "Metro2 Ruleset Violations", desc: "Detects structural violations of the Metro2 reporting format.", sev: "ERROR" },
  ...
  { title: "Time-Barred Debt Collection", desc: "Detects collection attempts on legally uncollectible stale debt.", sev: "ERROR" },
  ...
  { title: "Furnisher Re-aging Violation", desc: "Identifies illegal manipulation of the Date of First Delinquency (DOFD).", sev: "ERROR" },
  ...
  { title: "Collector Unauthorized Fees", desc: "Identifies illegal addition of collection fees or interest not provided by contract.", sev: "ERROR" },
  ...
  { title: "Collector Statute Revival Attempt", desc: "Identifies illegal attempts to restart the statute of limitations via partial payment tricks.", sev: "ERROR" }
];