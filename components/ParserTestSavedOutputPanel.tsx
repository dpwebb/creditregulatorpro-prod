...
const TRADELINE_FIELD_TEMPLATES = [
  ...
  ["scheduledMonthlyPayment", "Scheduled Payment"],
...
const IMPORTANT_TRADELINE_FIELDS: Array<[string, (tradeline: JsonRecord) => unknown]> = [
  ...
  ["Monthly Payment", (tradeline) => tradeline.monthlyPayment ?? tradeline.scheduledMonthlyPayment],
  ["Payment Frequency", (tradeline) => tradeline.paymentFrequency],
