...
const manuals: Manual[] = [
  {
    ...
    commonTasks: [
      task(
        ...
        [
          "Start on Home and identify whether the issue is a user/account problem, a compliance finding, or a packet generation problem.",
    ...
    commonTasks: [
      ...
      task(
        ...
        [
          ...
          "If a hidden-risk finding blocked packet generation, open Risk Triage or the relevant tradeline detail.",
        ],
        [
          "Use count mismatches as a starting point, not proof that a packet is missing.",
          "Distinguish packet generation, packet download, and packet delivery events.",
        ],
        [
    ...
    workflows: [
      workflow(
        ...
        [
          ...
          "Account: open when tradeline-level context, packet gate, dispute history, or account status matters.",
  ...
  },
  {
    ...
    purpose: "Use this section to verify sensitive changes, support investigations, reset workflows, settings updates, upload activity, packet generation, and admin review history.",
  ...
  },
  {
    ...
    group: "Platform",
    overview: "Letter Templates controls reusable wording for dispute and support packet generation. Template changes can affect customer-facing documents.",
    purpose: "Use this section to review, edit, and verify approved template language without changing unsupported legal conclusions or weakening required dispute context.",
    screenshotFocus: "The screenshot shows the template list, editor surfaces, save controls, and current template content areas.",
    mainPanels: [
      ["Template list", "Shows available packet or support templates.", "Select the exact template by purpose before editing."],
      ["Template editor", "Displays the editable body and fields.", "Keep wording specific, factual, and supported by platform evidence."],
      ["Save controls", "Persist approved template changes.", "Save only after review and keep a change note."],
      ["Preview/context", "Where available, helps check how content reads in generated materials.", "Preview before considering the change complete."],
    ],
    operatorNotes: [
      "Template edits can change user-facing packet language. Treat them as controlled content changes.",
      "Do not introduce legal advice or promises of outcome.",
      "If a template depends on variables, verify that missing variables render safely.",
    ],
    configurationScope: [
      "Template wording affects generated letters or packets.",
      "Saved text may be reused across many users and reports.",
      "Template changes should have an approval reason and regression/preview check.",
    ],
    workflows: [
      workflow(
        "Edit approved template wording",
        "Use when operations approves a wording correction or clarity improvement.",
        [
          "Open Letter Templates and select the exact template.",
          "Read the current wording and identify the section being changed.",
          "Compare the requested change to the template's intended use.",
          "Edit only the approved language. Avoid unrelated cleanup.",
          "Check variables and placeholders for spelling and supported names.",
          "Save and wait for confirmation.",
          "Refresh, reopen the template, and verify the text persists.",
          "Generate or preview a representative packet if the template is used in packet output.",
        ],
        [
          "Minor wording correction: save after internal approval.",
          "Legal/reference language change: route for compliance/legal review first.",
          "Variable behavior issue: escalate if preview output is wrong.",
        ],
        [
          "Text persists after refresh.",
          "Representative generated output contains correct wording.",
          "Change reason is documented.",
        ],
      ),
      workflow(
        "Review a template for plain language",
        "Use when support reports that customers misunderstand a packet phrase.",
        [
          "Open the template and identify the specific phrase.",
          "Read the surrounding paragraph so the edit does not remove required context.",
          "Rewrite for plain language while preserving facts, evidence requirements, and neutral tone.",
          "Avoid terms that sound like guaranteed legal findings unless the finding is actually confirmed.",
          "Preview the output and check line breaks, variables, and grammar.",
          "Save only after the wording is approved.",
        ],
        undefined,
        [
          "The revised wording is clearer and still accurate.",
    ...
    commonTasks: [
      task(
        "Fix a placeholder issue",
        "Example: A generated letter shows a blank creditor name.",
        [
          "Open the generated packet or support example and identify the blank field.",
          "Open Letter Templates and find the template that produced the section.",
          "Verify whether the placeholder name is correct and supported.",
          "If the placeholder is wrong, correct it and preview.",
          "If the placeholder is correct but the source data is missing, investigate parser/user data instead of changing the template.",
        ],
        [
          "Do not hard-code customer or creditor information into shared templates.",
          "Distinguish template defects from missing source data.",
        ],
        [
          "Preview output renders expected variables.",
          "Source data issues are escalated to the correct workflow.",
        ],
      ),
      task(
        "Retire obsolete wording",
        "Example: A template references an old workflow name.",
        [
          "Identify every template that uses the obsolete wording.",
          "Confirm the replacement wording and approval source.",
          "Edit one template at a time.",
          "Preview each affected packet/document path.",
          "Record the changed templates in the internal note.",
        ],
        [
          "Keep diffs focused.",
          "Avoid broad rewrites while fixing one obsolete phrase.",
        ],
        [
          "All affected templates were checked.",
          "No unrelated content changed.",
        ],
      ),
    ],
    commonErrors: defaultErrors("letter templates"),
    troubleshooting: defaultTroubleshooting("letter templates"),
    bestPractices: [
      "Edit one template at a time.",
      "Preview representative output.",
      "Keep legal and compliance wording evidence-based.",
      "Document why wording changed.",
    ],
    completionChecklist: commonCompletion("letter templates"),
    relatedPages: ["Admin Guide", "Rule Check Settings", "Risk Triage", "Packet workflows", "Activity Logs"],
  },
  {
    ...
    purpose: "Use this section to confirm bureau names, addresses, contact details, and operational context before packet generation, evidence review, or reference updates.",
    ...
    workflows: [
      workflow(
        ...
        "Use before packet generation or when a support ticket questions bureau address/contact data.",
        [
      ...
      workflow(
        ...
        "Use when a report layout or packet workflow behaves differently for a bureau.",
        [
    ...
    commonTasks: [
      task(
        ...
        [
          ...
          "Open Activity Logs for packet generation/delivery timing if needed.",
    ...
    relatedPages: ["Reporting Format Guide", "Letter Templates", "Activity Logs", "Parser Testing"],
  },
  {
    name: "Laws",
    slug: "laws",
  ...
  },
  {
    ...
    relatedPages: ["Laws", "Reporting Format Guide", "Finding Corrections", "Letter Templates", "Risk Triage"],
  },
  {
  ...
  },
  {
    ...
    workflows: [
      workflow(
        ...
        [
          ...
          "Identify impacted pages: Laws, obligations, Rule Check Settings, Letter Templates, Finding Corrections, Parser Testing, or Admin Guide.",
      ...
      workflow(
        ...
        [
          ...
          "Template update: revise Letter Templates and preview output.",
        ],
        [
    ...
    relatedPages: ["Laws", "Rule Check Settings", "Letter Templates", "Finding Corrections", "Parser Testing", "Admin Guide"],
  },
  {
    ...
    group: "Tools",
    overview: "Lifecycle Testing runs controlled mock-user workflows for end-to-end validation of registration, upload, parsing, account creation, packet generation, support, and cleanup behavior.",
    ...
    workflows: [
      ...
      workflow(
        ...
        [
          ...
          "Confirm packet generation uses correct user profile, template, bureau/creditor references, and evidence.",
