...
3. Design the response parser boundary only after capture/review workflow and automated smoke remain stable; do not add inbox integration, change packet readiness or wording, or add an admin override.
