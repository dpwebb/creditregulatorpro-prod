...
2. Add or update a gated authenticated response admin-review UI smoke harness, then run it against synthetic response `1` before relying on the new UI controls for release.
