...
2. Extend manual response capture only with more synthetic fixtures and replay tooling; keep response documents evidence/metadata only, keep later deterministic report comparison required for corrected/removed/unchanged, and do not treat email response as proof of correction.
