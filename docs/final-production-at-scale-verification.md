...
| High-growth list limits | Complete with noted exceptions | Tracker row 16 and list inventory. | API list-limit tests passed. | `hidden-risk/list`, parser-test list raw text, and consumer-signature list data remain documented follow-ups. | Partial for scale. |
