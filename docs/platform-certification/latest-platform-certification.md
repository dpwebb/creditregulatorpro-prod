...
Generated: 2026-05-26T03:31:33.611Z
Target: https://staging.creditregulatorpro.com
Branch: `staging`
Commit: `138452ae9d5d26a20b9e057949d59d0c4bf56579`
...
- Commands: 11 passed, 1 incomplete, 0 failed, 12 total
...
| --- | --- | --- | ---: | --- |
| Level 1 static code audit | Static Audit | PASS | 72s | `pnpm run audit:static` |
...
| Level 3 E2E operational audit | Operational Workflow | PASS | 94s | `pnpm run audit:e2e` |
| Level 4 adversarial/resilience audit | Resilience | PASS | 111s | `pnpm run audit:resilience` |
...
| Admin click-through certification | Admin Certification | PASS | 36s | `pnpm exec playwright test tests/e2e/admin-sidebar-routes.spec.ts tests/e2e/admin-security-functions.spec.ts` |
