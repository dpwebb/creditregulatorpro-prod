...
Generated at: 2026-05-22T05:08:00.822Z
...
- #1 Disaster recovery (Critical; requires-human-proof)
  ...
  Allowed commands: `pnpm run restore:drill:simulated`, `pnpm run restore:evidence:template`, `pnpm run restore:evidence:acceptance`, `pnpm run check:restore-drill-evidence`, `pnpm run restore:accept-human-evidence`, `pnpm run restore:evidence:current-check`, `pnpm run test:golden-path`, `pnpm run operator:dashboard`, `pnpm run response:soak-check`
