...
- Authenticated response admin-review UI smoke remains pending after the first UI control deployment; run a gated synthetic admin UI review smoke before relying on the new metadata review controls for release.
