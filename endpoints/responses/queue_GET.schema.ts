...
import type { ListResponseProcessingJobsResult } from "../../helpers/responseProcessingQueueService";
...
export type OutputType = ListResponseProcessingJobsResult;

export const getResponseProcessingQueue = async (
  params?: InputType,
  init?: RequestInit,
): Promise<OutputType> => {
  ...
  const result = await fetch(`/_api/responses/queue${queryString}`, {
    method: "GET",
    ...init,
    headers: {
