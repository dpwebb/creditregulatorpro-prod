    ...
    const sections = [
      {
        ...
        items: [
          ...
          "Bureau-specific parsing (TransUnion, Equifax, PDF text layouts)",
          "Auto bureau detection (weighted scoring)",
          "Dual-pass deterministic extraction (Pass A quick, Pass A Full comprehensive)",
          ...
          "Scanned document support requires deterministic OCR before canonical ingestion",
        ],
      },
      {
