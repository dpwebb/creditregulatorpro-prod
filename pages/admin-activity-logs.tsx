...
export default function AdminActivityLogsPage() {
  ...
  const { data, isFetching, isError } = useAuditLogs(filters);
  ...
  return (
    <div className={styles.container}>
      <PageHeader
        title="Activity Logs"
        subtitle="Monitor user sessions, authentication events, and system actions."
      ...
      <div className={styles.filters}>
        ...
        <div className={styles.filterGroup}>
          <Select
            value={actionType}
            onValueChange={(val) => handleFilterChange(() => setActionType(val))}
          >
      ...
      <div className={styles.cardList}>
        {isFetching && logs.length === 0 ? (
          ...
          logs.map((log) => (
            <div key={log.id} className={`${styles.logCard} ${isFetching ? styles.logCardFetching : ""}`}>
              <div
